import {StartingOrder, Discipline, AthleteID} from "./disciplines"
import { useState } from 'react';


export function StartingOrderEditButton({ discipline, group_name, updateStartingOrder }: { discipline: Discipline, group_name: string, updateStartingOrder: (order: StartingOrder) => void }) {
    ...
    if (typeof discipline.starting_order == "string" || discipline.state == "Finished") {
        ...
        <td className='border border-slate-800 p-1 pl-4 pr-4  '>
          <div className='flex justify-center w-full'>
            <span className='flex'>
              ...
              {typeof discipline.starting_order == "string" && "Ohne Reihenfolge"}
      ...
      return (
        <td className='border border-slate-800 p-1 pl-4 pr-4 ' >
          <div className='flex justify-center w-full bg-slate-300 rounded-s-md shadow-md hover:bg-slate-600 hover:text-slate-50 hover:cursor-pointer  group'

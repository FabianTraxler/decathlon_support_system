export const decathlon_age_groups = ["AK-M", "M40", "M50", "M60", "AK-W", "W40", "W50", "W60","Staffel"]
export const groups = [1, 2, 3, 4, 5, 6, 7, 8]
export const youth_groups = ["U4/U6", "U8", "U10", "U12", "U14/U16"] 
export const long_distance_disciplines = ["1500 Meter Lauf", "1200 Meter Cross Lauf", "1000 Meter Lauf", "400 Meter Lauf"]

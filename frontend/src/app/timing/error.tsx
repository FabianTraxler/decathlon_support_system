    ...
    return (
        <div className='h-screen w-screen flex items-center justify-center'>
            <div className='max-w-[80%] border rounded-md shadow-md p-3 bg-slate-300'>
                <div className='text-center text-red-600 font-bold text-xl'>Verbindung zur Datenbank verloren!</div>

                <div className='font-bold text-center'>Alle Werte auf Papier mitschreiben</div>
                <div className='text-center m-2'>Wenn Verbindung wieder vorhanden ist, sollte die App wieder funktionieren.</div>
